...
const uint32_t UPGRADE_HEIGHT_V2                             = 1; // Upgrade height for CN-Turtle Variant 2 from Variant 1.
...
const int      P2P_DEFAULT_PORT                              =  25500;
const int      RPC_DEFAULT_PORT                              =  25501;
const int      SERVICE_DEFAULT_PORT                          =  25502;
...
{
    {  0x6c, 0x69, 0x74, 0x68, 0x65, 0x20, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x63  }
};
