...
function usage()
{
    ...
    echo "and generates the checksum files of the Lithe tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/lithe-project/lithe.git"
CLONE_DIR="$BUILD_DIRECTORY/lithe-buildall"
TARGET_DIR="$BUILD_DIRECTORY/lithe-releases"
DYNAMIC_RELEASE="lithe-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="lithe-${TAG_VERSION}-linux-staticboost-CLI"
